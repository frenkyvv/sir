...
;// CONCATENATED MODULE: ./src/components/formulas/DobutaminaForm.js
class DobutaminaForm extends (index_js_default()).Component{constructor(props){super(props);this.state={nombre:"",edad:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;const edad=target.edad;this.setState({[name]:value,[edad]:value});}handleSubmit(event){const pes=this.state.nombre;const dos=this.state.edad;document.querySelector("#textoPrevio").textContent="El resultado es: ";const res=pes*dos/83.33;const resultado=res.toFixed(2);document.querySelector("#resultado").textContent=resultado;event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Peso: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"nombre",type:"number",value:this.state.name,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicPassword"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Dosis: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"edad",type:"number",value:this.state.edad,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(ButtonDiv,null,/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",type:"submit",value:"Submit"},"Submit"),/*#__PURE__*/index_js_default().createElement("div",{id:"textoPrevio"}),/*#__PURE__*/index_js_default().createElement("div",{id:"resultado"})));}}/* harmony default export */ const formulas_DobutaminaForm = (DobutaminaForm);const ButtonDiv=styled_components_esm/* default.div */.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
`;
;// CONCATENATED MODULE: ./src/pages/page-3.js
function Pagina3(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(Wrapper,null,/*#__PURE__*/index_js_default().createElement(ContentWrapper,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Dobutamina"}),/*#__PURE__*/index_js_default().createElement(TextWrapper,null,/*#__PURE__*/index_js_default().createElement(Title,null,"Dosis de Dobutamina"),/*#__PURE__*/index_js_default().createElement(Description,null,"Formula para calcular la dosis de Dobutamina")),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(FormWrapper,null,/*#__PURE__*/index_js_default().createElement(formulas_DobutaminaForm,null))),/*#__PURE__*/index_js_default().createElement(BackBut,null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(BotonLink/* default */.Z,{text:"Back"})))));}/* harmony default export */ const page_3 = (Pagina3);const Wrapper=styled_components_esm/* default.div */.ZP.div`
