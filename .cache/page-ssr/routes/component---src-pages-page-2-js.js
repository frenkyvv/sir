...
;// CONCATENATED MODULE: ./src/components/formulas/DopaminaForm.js
class DopaminaForm extends (index_js_default()).Component{constructor(props){super(props);this.state={nombre:"",edad:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;const edad=target.edad;this.setState({[name]:value,[edad]:value});}handleSubmit(event){const pes=this.state.nombre;const dos=this.state.edad;document.querySelector("#textoPrevio").textContent="El resultado es: ";const res=pes*dos/66.6;const resultado=res.toFixed(2);document.querySelector("#resultado").textContent=resultado;event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Peso: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"nombre",type:"number",value:this.state.name,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicPassword"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Dosis: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"edad",type:"number",value:this.state.edad,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(ButtonDiv,null,/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",type:"submit",value:"Submit"},"Submit"),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement("div",{id:"textoPrevio"}),/*#__PURE__*/index_js_default().createElement("div",{id:"resultado"})));}}/* harmony default export */ const formulas_DopaminaForm = (DopaminaForm);const ButtonDiv=styled_components_esm/* default.div */.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
`;
;// CONCATENATED MODULE: ./src/pages/page-2.js
function SecondPage(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(Wrapper,null,/*#__PURE__*/index_js_default().createElement(ContentWrapper,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Dopamina"}),/*#__PURE__*/index_js_default().createElement(TextWrapper,null,/*#__PURE__*/index_js_default().createElement(Title,null,"Dosis de Dopamina"),/*#__PURE__*/index_js_default().createElement(Description,null,"Formula para calcular la dosis de Dopamina")),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(FormWrapper,null,/*#__PURE__*/index_js_default().createElement(formulas_DopaminaForm,null))),/*#__PURE__*/index_js_default().createElement(BackBut,null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(BotonLink/* default */.Z,{text:"Back"})))));}/* harmony default export */ const page_2 = (SecondPage);const Wrapper=styled_components_esm/* default.div */.ZP.div`
