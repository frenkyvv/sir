...
;// CONCATENATED MODULE: ./src/components/formulas/SodioCorregidoForm.js
class SodioForm extends (index_js_default()).Component{constructor(props){super(props);this.state={nombre:"",edad:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;const edad=target.edad;this.setState({[name]:value,[edad]:value});}handleSubmit(event){const sod=this.state.nombre;const glu=this.state.edad;const uno=glu-100;const dos=0.016*uno;const total=parseFloat(sod)+parseFloat(dos);let total1=total.toFixed(1);document.querySelector("#resultado").textContent=`Sodio Corregido: `+total1;event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Sodio: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"nombre",type:"number",value:this.state.name,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicPassword"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Glucosa: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"edad",type:"number",value:this.state.edad,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(ButtonDiv,null,/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",type:"submit",value:"Submit"},"Submit"),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(Resultado,null,/*#__PURE__*/index_js_default().createElement("div",{id:"resultado"}))));}}/* harmony default export */ const SodioCorregidoForm = (SodioForm);const Resultado=styled_components_esm/* default.div */.ZP.div`
  #resultado {
    color: black;
  }
...
`;
;// CONCATENATED MODULE: ./src/pages/page-6.js
function Pagina6(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(Wrapper,null,/*#__PURE__*/index_js_default().createElement(ContentWrapper,null,/*#__PURE__*/index_js_default().createElement(TextWrapper,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Sodio Corregido"}),/*#__PURE__*/index_js_default().createElement(Title,null,"Sodio Corregido"),/*#__PURE__*/index_js_default().createElement(Description,null,"Formula para calcular el sodio corregido")),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(FormWrapper,null,/*#__PURE__*/index_js_default().createElement(SodioCorregidoForm,null))),/*#__PURE__*/index_js_default().createElement(BackBut,null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(BotonLink/* default */.Z,{text:"Back"})))));}/* harmony default export */ const page_6 = (Pagina6);const Wrapper=styled_components_esm/* default.div */.ZP.div`
...
;
//# sourceMappingURL=component---src-pages-page-6-js.js.map