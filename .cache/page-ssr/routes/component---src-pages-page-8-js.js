...
var Form = __webpack_require__(1444);
;// CONCATENATED MODULE: ./src/components/formulas/OsmoPlas.js
class OsmoPlasmaticaForm extends (index_js_default()).Component{constructor(props){super(props);this.state={sodio:"",potasio:"",glucosa:"",urea:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(e){const target=e.target;const value=target.value;const sodio=target.name;const potasio=target.name;const glucosa=target.name;const urea=target.name;this.setState({[sodio]:value,[potasio]:value,[glucosa]:value,[urea]:value});}handleSubmit(e){const sod=this.state.sodio;const pot=this.state.potasio;const glu=this.state.glucosa;const ure=this.state.urea;const res=glu/18+ure/6+pot*2+sod*2;document.querySelector("#resu").textContent=`${res.toFixed(1)}`;jquery_default()("#etiquetas").hide();jquery_default()("#botondes").hide();e.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,null,/*#__PURE__*/index_js_default().createElement("div",{id:"etiquetas"},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"sodioInput"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Sodio:"),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"sodio",onChange:this.handleChange,value:this.state.sodio,type:"number"})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"glucosaInput"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Glucosa:"),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"glucosa",value:this.state.glucosa,onChange:this.handleChange,type:"number"})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"potasioInput"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Potasio:"),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"potasio",type:"number",value:this.state.potasio,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"ureaInput"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Urea:"),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"urea",type:"number",value:this.state.urea,onChange:this.handleChange}))),/*#__PURE__*/index_js_default().createElement(ButtonDiv,null,/*#__PURE__*/index_js_default().createElement("div",{id:"botondes"},/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",onClick:this.handleSubmit},"Submit")),/*#__PURE__*/index_js_default().createElement("div",{id:"resu"})));}}/* harmony default export */ const OsmoPlas = (OsmoPlasmaticaForm);const ButtonDiv=styled_components_esm/* default.div */.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
`;
;// CONCATENATED MODULE: ./src/components/formulas/OsmoEfe.js
class OsmoEfectiva extends (index_js_default()).Component{constructor(props){super(props);this.state={nombre:"",edad:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;const edad=target.name;this.setState({[name]:value,[edad]:value});}handleSubmit(event){const sod=this.state.nombre;const glu=this.state.edad;const res=glu/18+sod*2;document.querySelector("#resultado").textContent=`${res.toFixed(1)}`;jquery_default()("#boton").hide();jquery_default()("#botonesdes").hide();jquery_default()("#textoPrevio").show();event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Wrapper,null,/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement("div",{id:"boton"},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Forma,null,/*#__PURE__*/index_js_default().createElement("div",{id:"labels"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Sodio: "))),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"nombre",type:"number",value:this.state.name,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicPassword"},/*#__PURE__*/index_js_default().createElement(Forma,null,/*#__PURE__*/index_js_default().createElement("div",{id:"labels"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Glucosa: "))),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"edad",type:"number",value:this.state.edad,onChange:this.handleChange}))),/*#__PURE__*/index_js_default().createElement(OsmoEfe_ButtonDiv,null,/*#__PURE__*/index_js_default().createElement("div",{id:"botonesdes"},/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",type:"submit",value:"Submit"},"Submit")),/*#__PURE__*/index_js_default().createElement(TextoResultado,null,/*#__PURE__*/index_js_default().createElement("div",{id:"textoPrevio"},"La Osmolaridad es de: ")),/*#__PURE__*/index_js_default().createElement(ResultadoDiv,null,/*#__PURE__*/index_js_default().createElement("div",{id:"resultado"})))));}}/* harmony default export */ const OsmoEfe = (OsmoEfectiva);const Forma=styled_components_esm/* default.div */.ZP.div`
  #labels {
    color: black;
  }
`;const Wrapper=styled_components_esm/* default.div */.ZP.div``;const TextoResultado=styled_components_esm/* default.div */.ZP.div`
  #textoPrevio {
    color: black;
    display: none;
  }
`;const ResultadoDiv=styled_components_esm/* default.div */.ZP.div`
  #resultado {
    text-align: center;
    color: black;
  }
`;const OsmoEfe_ButtonDiv=styled_components_esm/* default.div */.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
`;
;// CONCATENATED MODULE: ./src/pages/page-8.js
class Pagina8 extends (index_js_default()).Component{clickHombre(e){jquery_default()("#escoger").hide();jquery_default()("#formHom").show();}clickMujer(e){jquery_default()("#escoger").hide();jquery_default()("#formMuj").show();}render(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(page_8_Wrapper,null,/*#__PURE__*/index_js_default().createElement(ContentWrapper,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Deficit de Agua"}),/*#__PURE__*/index_js_default().createElement(TextWrapper,null,/*#__PURE__*/index_js_default().createElement(Titulo,null,"Osmolaridad"),/*#__PURE__*/index_js_default().createElement(Description,null,"Formula para calcular la Osmolaridad"),/*#__PURE__*/index_js_default().createElement("div",{id:"escoger"},/*#__PURE__*/index_js_default().createElement(Botones,null,/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",onClick:this.clickHombre,id:"botHom"},"Plasmatica"),/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",onClick:this.clickMujer,id:"botMujer"},"Especifica"))),/*#__PURE__*/index_js_default().createElement(FormHombre,{id:"formHom"},/*#__PURE__*/index_js_default().createElement(OsmoPlas,null)),/*#__PURE__*/index_js_default().createElement(FormMujer,{id:"formMuj"},/*#__PURE__*/index_js_default().createElement(OsmoEfe,null)))),/*#__PURE__*/index_js_default().createElement(BackBut,null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(BotonLink/* default */.Z,{text:"Back"})))));}}/* harmony default export */ const page_8 = (Pagina8);const page_8_Wrapper=styled_components_esm/* default.div */.ZP.div`
  background: linear-gradient(180deg, #697ea0 0%, #69b6fd 100%);
`;const ContentWrapper=styled_components_esm/* default.div */.ZP.div`
  width: 100%;
  height: 600px;
`;const TextWrapper=styled_components_esm/* default.div */.ZP.div`
  padding-top: 30px;
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
  width: 100%;
`;const Titulo=styled_components_esm/* default.h1 */.ZP.h1`
  font-weight: bold;
  font-size: 30px;
`;const Description=styled_components_esm/* default.p */.ZP.p`
  font-size: 13px;
  line-height: 130%;
  margin-top: 10px;
  border-top: 2px solid black;
`;const Botones=styled_components_esm/* default.div */.ZP.div`
  max-width: 300px;
  display: grid;
  grid-template-columns: 1fr 1fr;
  grid-gap: 10px;
`;const BackBut=styled_components_esm/* default.div */.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
  padding-top: 30px;
  padding-bottom: 50px;
`;const FormHombre=styled_components_esm/* default.div */.ZP.div`
  display: none;
`;const FormMujer=styled_components_esm/* default.div */.ZP.div`
  display: none;
`;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ react_bootstrap_esm_Button)
});
...
const Button_Button = /*#__PURE__*/index_js_.forwardRef(({
  as,
  bsPrefix,
  variant,
  size,
...
const Feedback = /*#__PURE__*/index_js_.forwardRef(
...
const FormContext = /*#__PURE__*/index_js_.createContext({});
...
const FormCheckInput = /*#__PURE__*/index_js_.forwardRef(({
  id,
  bsPrefix,
  className,
  type = 'checkbox',
  ...
  const {
    controlId
  } = (0,index_js_.useContext)(esm_FormContext);
...
const FormCheckLabel = /*#__PURE__*/index_js_.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
function hasChildOfType(children, type) {
  return index_js_.Children.toArray(children).some(child => /*#__PURE__*/index_js_.isValidElement(child) && child.type === type);
}
...
const FormCheck = /*#__PURE__*/index_js_.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const innerFormContext = (0,index_js_.useMemo)(() => ({
...
const FormControl = /*#__PURE__*/index_js_.forwardRef(({
  bsPrefix,
  type,
  size,
  htmlSize,
...
const FormGroup = /*#__PURE__*/index_js_.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'div',
  ...props
...
const Col = /*#__PURE__*/index_js_.forwardRef(
// Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
(props, ref) => {
  const [{
    className,
...
const FormLabel = /*#__PURE__*/index_js_.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'label',
  bsPrefix,
  column,
...
const FormRange = /*#__PURE__*/index_js_.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
const FormSelect = /*#__PURE__*/index_js_.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
...
const FormText = /*#__PURE__*/index_js_.forwardRef(
// Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
({
  bsPrefix,
  className,
...
const Switch = /*#__PURE__*/index_js_.forwardRef((props, ref) => /*#__PURE__*/(0,jsx_runtime.jsx)(esm_FormCheck, {
  ...props,
  ref: ref,
  type: "switch"
}));
...
const FloatingLabel = /*#__PURE__*/index_js_.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
const Form = /*#__PURE__*/index_js_.forwardRef(({
  className,
  validated,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'form',
...
;
//# sourceMappingURL=component---src-pages-page-8-js.js.map