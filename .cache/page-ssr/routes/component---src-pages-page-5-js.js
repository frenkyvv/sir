...
;// CONCATENATED MODULE: ./src/components/formulas/BicaForm.js
class BicarbonatoForm extends (index_js_default()).Component{constructor(props){super(props);this.state={nombre:"",edad:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;const edad=target.edad;this.setState({[name]:value,[edad]:value});}handleSubmit(event){const pes=this.state.nombre;const hco=this.state.edad;let pesr=pes*0.4;let hcor=24-hco;let resu=pesr*hcor;let entre3=resu/3;let fcos=entre3/7.5;document.querySelector("#resultado").textContent=`El deficit de HCO3 es: ${resu.toFixed(0)} mEq/L, el cual dividimos entre 3 
        para administrarlo cada 8 hrs serian: ${entre3.toFixed(1)}. Si dividimos entre las cantidad de mEq/L por frasco
        serian ${fcos.toFixed(0)} frascos, si es mayor de 10, se puede dividir la dosis en dos partes y aplicar la mitad 
        directa y la otra mitad diluirla en 250 ml de Sol. Fisiologica.`;event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Peso: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"nombre",type:"number",value:this.state.name,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicPassword"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Bicarbonato: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"edad",type:"number",value:this.state.edad,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(ButtonDiv,null,/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",type:"submit",value:"Submit"},"Submit"),/*#__PURE__*/index_js_default().createElement(Resultado,null,/*#__PURE__*/index_js_default().createElement("div",{id:"resultado"}))));}}/* harmony default export */ const BicaForm = (BicarbonatoForm);const Resultado=styled_components_esm/* default.div */.ZP.div`
  #resultado {
    text-align: center;
    max-width: 450px;
    color: white;
  }
`;const ButtonDiv=styled_components_esm/* default.div */.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
`;
;// CONCATENATED MODULE: ./src/pages/page-5.js
function Pagina5(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(Wrapper,null,/*#__PURE__*/index_js_default().createElement(ContentWrapper,null,/*#__PURE__*/index_js_default().createElement(TextWrapper,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Bicarbonato"}),/*#__PURE__*/index_js_default().createElement(Title,null,"Deficit de Bicarbonato"),/*#__PURE__*/index_js_default().createElement(Description,null,"Formula para calular el deficit de bicarbonato")),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(FormWrapper,null,/*#__PURE__*/index_js_default().createElement(BicaForm,null))),/*#__PURE__*/index_js_default().createElement(BackBut,null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(BotonLink/* default */.Z,{text:"Back"})))));}/* harmony default export */ const page_5 = (Pagina5);const Wrapper=styled_components_esm/* default.div */.ZP.div`
...
`;const FormWrapper=styled_components_esm/* default.div */.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
;
//# sourceMappingURL=component---src-pages-page-5-js.js.map