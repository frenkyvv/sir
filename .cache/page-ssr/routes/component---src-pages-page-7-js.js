...
;// CONCATENATED MODULE: ./src/components/formulas/AlteplaseForm.js
class AlteplaseForm extends (index_js_default()).Component{constructor(props){super(props);this.state={peso:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;this.setState({[name]:value});}handleSubmit(event){const pes=this.state.peso;let todo=pes*0.9;let bolo=todo*0.1;let resto=todo-bolo;document.querySelector("#resultado").textContent=`Le corresponde ${todo.toFixed(0)} mg: Pasar bolo de ${bolo.toFixed(0)} mg y posterior pasar ${resto.toFixed(0)} mg en 60 min IV. 
          En caso de ser mas de 90 mg totales, pasar 9 mg en bolo y 81 mg en 60 min IV infusion continua.`;event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Peso: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"peso",type:"number",value:this.state.peso,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(ButtonDiv,null,/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",type:"submit",value:"Submit"},"Submit"),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(Resultado,null,/*#__PURE__*/index_js_default().createElement("div",{id:"resultado"}))));}}/* harmony default export */ const formulas_AlteplaseForm = (AlteplaseForm);const Resultado=styled_components_esm/* default.div */.ZP.div`
  #resultado {
    color: black;
    text-align: center;
  }
`;const ButtonDiv=styled_components_esm/* default.div */.ZP.div`
  ...
  max-width: 300px;
`;
;// CONCATENATED MODULE: ./src/pages/page-7.js
function Pagina7(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(Wrapper,null,/*#__PURE__*/index_js_default().createElement(ContentWrapper,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Dopamina"}),/*#__PURE__*/index_js_default().createElement(TextWrapper,null,/*#__PURE__*/index_js_default().createElement(Title,null,"Dosis de Alteplase"),/*#__PURE__*/index_js_default().createElement(Description,null,"Formula para el uso del Alteplase")),/*#__PURE__*/index_js_default().createElement("br",null),/*#__PURE__*/index_js_default().createElement(FormWrapper,null,/*#__PURE__*/index_js_default().createElement(formulas_AlteplaseForm,null))),/*#__PURE__*/index_js_default().createElement(BackBut,null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(BotonLink/* default */.Z,{text:"Back"})))));}const Wrapper=styled_components_esm/* default.div */.ZP.div`
...
;
//# sourceMappingURL=component---src-pages-page-7-js.js.map