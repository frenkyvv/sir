...
;// CONCATENATED MODULE: ./src/components/formulas/DeficitHombre.js
class DeficitHombre extends (index_js_default()).Component{constructor(props){super(props);this.state={nombre:"",edad:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;const edad=target.edad;this.setState({[name]:value,[edad]:value});}handleSubmit(event){jquery_default()("#footwrapp").show();jquery_default()("#But").hide();const peso=this.state.nombre;const edad=this.state.edad;const prim=peso*0.5;const sec=edad/140;const ter=sec-1;const resul=prim*ter;const resultado=resul.toFixed(1);document.querySelector("#resulta").textContent=`Se requieren ${resultado} Litros, para llevar el Sodio a 140 mEq/dl`;event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Peso: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"nombre",type:"number",value:this.state.name,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicPassword"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Na serico: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"edad",type:"number",value:this.state.edad,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{id:"But",variant:"primary",type:"submit",value:"Submit"},"Submit"),/*#__PURE__*/index_js_default().createElement(Footwrapp,{id:"footwrapp"},/*#__PURE__*/index_js_default().createElement("div",{id:"resulta"})));}}/* harmony default export */ const formulas_DeficitHombre = (DeficitHombre);const Footwrapp=styled_components_esm/* default.div */.ZP.div`
  font-size: 20px;
  max-width: 380px;
  height: 120px;
  display: none;
...
`;
;// CONCATENATED MODULE: ./src/components/formulas/DeficitMujer.js
class DeficitMujer extends (index_js_default()).Component{constructor(props){super(props);this.state={nombre:"",edad:""};this.handleChange=this.handleChange.bind(this);this.handleSubmit=this.handleSubmit.bind(this);}handleChange(event){const target=event.target;const value=target.value;const name=target.name;const edad=target.edad;this.setState({[name]:value,[edad]:value});}handleSubmit(event){const peso=this.state.nombre;const edad=this.state.edad;const prim=peso*0.6;const sec=edad/140;const ter=sec-1;const resul=prim*ter;const resultado=resul.toFixed(1);document.querySelector("#resultado").textContent=`Se requieren ${resultado} Litros, para llevar el Sodio a 140 mEq/dl`;event.preventDefault();}render(){return/*#__PURE__*/index_js_default().createElement(Form/* default */.Z,{onSubmit:this.handleSubmit},/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicEmail"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Peso: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"nombre",type:"number",value:this.state.name,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Form/* default.Group */.Z.Group,{className:"mb-3",controlId:"formBasicPassword"},/*#__PURE__*/index_js_default().createElement(Form/* default.Label */.Z.Label,null,"Na serico: "),/*#__PURE__*/index_js_default().createElement(Form/* default.Control */.Z.Control,{name:"edad",type:"number",value:this.state.edad,onChange:this.handleChange})),/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",type:"submit",value:"Submit"},"Submit"),/*#__PURE__*/index_js_default().createElement("div",{id:"resultado"}));}}/* harmony default export */ const formulas_DeficitMujer = (DeficitMujer);
;// CONCATENATED MODULE: ./src/pages/page-4.js
class Pagina4 extends (index_js_default()).Component{clickHombre(e){jquery_default()("#escoger").hide();jquery_default()("#formHom").show();}clickMujer(e){jquery_default()("#escoger").hide();jquery_default()("#formMuj").show();}render(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(Wrapper,null,/*#__PURE__*/index_js_default().createElement(ContentWrapper,null,/*#__PURE__*/index_js_default().createElement(seo/* default */.Z,{title:"Deficit de Agua"}),/*#__PURE__*/index_js_default().createElement(TextWrapper,null,/*#__PURE__*/index_js_default().createElement(Titulo,null,"Deficit de Agua"),/*#__PURE__*/index_js_default().createElement(Description,null,"Formula para calcular el deficit de Agua"),/*#__PURE__*/index_js_default().createElement("div",{id:"escoger"},/*#__PURE__*/index_js_default().createElement(Botones,null,/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",onClick:this.clickHombre,id:"botHom"},"Hombre"),/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{variant:"primary",onClick:this.clickMujer,id:"botMujer"},"Mujer"))),/*#__PURE__*/index_js_default().createElement(FormHombre,{id:"formHom"},/*#__PURE__*/index_js_default().createElement(formulas_DeficitHombre,null)),/*#__PURE__*/index_js_default().createElement(FormMujer,{id:"formMuj"},/*#__PURE__*/index_js_default().createElement(formulas_DeficitMujer,null)))),/*#__PURE__*/index_js_default().createElement(BackBut,null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(BotonLink/* default */.Z,{text:"Back"})))));}}/* harmony default export */ const page_4 = (Pagina4);const Wrapper=styled_components_esm/* default.div */.ZP.div`
...
;
//# sourceMappingURL=component---src-pages-page-4-js.js.map